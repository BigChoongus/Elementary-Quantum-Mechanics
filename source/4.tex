\chapter{State Space Operators and the Quantum Observables Problem}
...
\begin{enumerate}
    \item[P2A1.] All physical observables are represented by hermitian operators whose eigenvectors form an eigenbasis which spans the state space. For brevity it is customary to call these operators which represent physical operators \sapos{observable operators} throughout the course of this book.
